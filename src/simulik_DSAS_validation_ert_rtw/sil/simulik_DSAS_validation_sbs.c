/*
 * simulik_DSAS_validation_sbs.c
 *
 * Automatically generated s-function with I/O interface for:
 * Component: simulik_DSAS_validation
 * Component Simulink Path: simulik_DSAS_validation
 * Simulation Mode: SIL
 *
 */

#define S_FUNCTION_NAME                simulik_DSAS_validation_sbs
...
static RegMdlInfo rtMdlInfo_simulik_DSAS_validation[1] = { "",
...
static boolean_T startAndSetupApplication(SimStruct *S)
{
...

  {
    ...
    {
      mxArray * codeGenComponent = mxCreateString("simulik_DSAS_validation");
      mxArray *rhs[3];
      char * simulinkBlockPath = getSimulinkBlockPath(S);
      if (simulinkBlockPath == NULL) {
        ssSetErrorStatus(S,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (S->mdlInfo->genericFcn != (NULL) &&
    ...
    ssRegModelRefMdlInfo(S, (char *)"simulik_DSAS_validation",
                         rtMdlInfo_simulik_DSAS_validation, 1);
  }
