...
## Generated on : Thu Jun 25 22:32:28 2026
## Final product: ./simulik_DSAS_validation.exe
...
MODELREF_LINK_RSPFILE     = simulik_DSAS_validation_ref.rsp
...
PRODUCT = ./simulik_DSAS_validation.exe
...
MODELREF_LIBS = ../rtGetInf.obj ../rtGetNaN.obj ../rt_nonfinite.obj ../simulik_DSAS_validation.obj ../simulik_DSAS_validation_data.obj

LIBS = $(START_DIR)/simulik_DSAS_validation_ert_rtw/coderassumptions/lib/simulik_DSAS_validation_ca.lib
...
xil_interface.obj : $(START_DIR)/simulik_DSAS_validation_ert_rtw/sil/xil_interface.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sil_main.obj : $(START_DIR)/simulik_DSAS_validation_ert_rtw/sil/sil_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
